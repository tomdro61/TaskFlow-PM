// renderer/focus-mode.js — Focus mode, pomodoro timer, AI chat

export function getFocusTaskQueue() {
...
export function setTimerForCurrentTask() {
...
export function minimizeFocusMode() {
    this.focusMode.active = false;
...
export function expandFocusMode() {
    this.focusMode.active = true;
    this.focusMode.minimized = false;
...
export function updateMiniWidget() {
    const task = this.focusMode.taskQueue[this.focusMode.currentIndex];
    if (!task) return;
...
export function updateMiniTimerDisplay() {
...
export function updateNativePill() {
    const task = this.focusMode.taskQueue[this.focusMode.currentIndex];
    if (!task) return;
...
export function handlePillAction(action) {
    switch (action) {
      case 'complete':
...
export function initMiniWidgetDrag() {
...
export function showFocusEmpty() {
...
export function renderFocusTask() {
    const task = this.focusMode.taskQueue[this.focusMode.currentIndex];
    if (!task) {
      this.showFocusEmpty();
      return;
...
export function renderFocusSubtasks(task) {
...
export function toggleSettingsPanel(open = null) {
...
export function handleTimerSetting(action) {
    switch (action) {
      case 'work-plus':
...
export function updateAIContext(task) {
...
export function handleAISuggestion(promptType) {
    const task = this.focusMode.taskQueue[this.focusMode.currentIndex];
    if (!task) return;
...
export function addAIMessage(text, type) {
    const chat = document.getElementById('ai-chat');
...
export function generateAIResponse(promptType, task, customMessage = '') {
    const chat = document.getElementById('ai-chat');
...
export function generateBreakdownResponse(task) {
...
export function generateUnstuckResponse(task) {
    const tips = [
...
export function generateMotivationResponse(task) {
    const motivations = [
...
export function generateEstimateResponse(task) {
...
export function generateCustomResponse(task, message) {
    const responses = [
