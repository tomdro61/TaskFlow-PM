// renderer/recaps.js — Recap views, log, saved recaps, daily review

export function renderRecapsView() {
...
export function openCompletionSummaryModal(taskId) {
...
export function bindViewToggle() {
...
export function renderRecapLog(container) {
...
export function renderSavedRecaps(container) {
...
export function openAddRecapEntryModal() {
  const modalHtml = `
...
export function openSaveRecapModal() {
  const today = this.getLocalDateString();
...
export function generateRecap(period, refDateStr, summary) {
...
export function deleteRecapEntry(entryId) {
...
export function showSavedRecapDetail(recapId) {
...
export function showRecapDetail(dateStr) {
...
export function openDailyReview() {
  const today = this.getLocalDateString();
  const allTasks = this.getAllTasks();
